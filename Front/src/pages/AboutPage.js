...
function AboutPage(props) {
    ...
    return (
        <div>
            ...
            <Content>
                <p>Hello, my name is Jonathan. I'm a full stack software engineer with experince in React, Express.js, Node.js, PostgreSQL and Firebase.</p>
                ...
                <p>My latest project invlovled building my portfolio using React and setting up a backend to host my contact form submissions. My portfolio was built using React, Express.js, Bootstrap, Firebase and Node.js.</p>
