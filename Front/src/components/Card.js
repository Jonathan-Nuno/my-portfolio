...
function Card(props) {
    ...
    return (
        ...
        <div className='d-inline-block j-card'>
            ...
            { <CardModal builtWith={props.item.builtWith} thirdTitle={props.item.thirdTitle} secondTitle={props.item.secondTitle} subTitle={props.item.subTitle} description={props.item.description} /> }
        </div>
    );
}
